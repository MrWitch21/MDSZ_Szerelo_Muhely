                    ...
                    <div class="flex justify-between items-center pb-6 pt-2 pl-4 pr-4 rounded-t dark:border-gray-600">
                        ...
                        <div class="pr-8">
                            <a href="work_process/create">
                                <button type="button"
                                    class="py-2 px-4 flex items-center text-base font-semibold text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 transition duration-300 ease-in-out"
                            ...
                            <tbody>
                                @foreach ($work_processes as $work_process)
                                    <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">
                                            {{ $work_process->created_at }}</td>
                                        <td
                                            class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="flex items-center justify-center">
                                                <a href="/work_process/{{ $work_process->id }}/edit">
                                                    <button type="button"
