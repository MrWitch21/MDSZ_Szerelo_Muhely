...
<div class="relative w-4/5 mt-14 p-2 mx-auto max-w-md sm:p-4">
    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        ...
        <form action="/worksheet/{{ $worksheet->id }}/{{ $component->id }}/component/update" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                ...
                <div>
                    <label for="quantity" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alkatrész mennyisége</label>
        ...
        <form action="/worksheet/{{ $worksheet->id }}/{{ $component->id }}/component/destroy" method="post" class="mt-[-36px]">
            @csrf
            @method('delete')
